...
cd /beegfs/data/soukkal/Thesis/Cotesia_project/results/Quast/Quast_sum

#On crée le fichier final et on y insère un header :
echo species Total_Length GC N50 > Genomes_stats.txt
...
do
        ...
        paste -sd ' '  tmp_file.txt >> Genomes_stats.txt
done
